...
mydir = os.getcwd()
df_train = pd.read_csv(mydir+'/Homesite/Data/train.csv')
df_test = pd.read_csv(mydir+'/Homesite/Data/test.csv')
...
bst = xgb.train(param, xg_train, num_round, evallist, early_stopping_rounds=10)
...
sub.to_csv(mydir+'sub.csv', index=False)
